...
const (
	...
	IdAddCategoryCloseButton    = "add-category-close-button"
	IdAddCategoryModalTitle     = "add-category-modal-title"
	IdAddCategoryFileInput      = "add-category-file-picker-input"
